...
@smokeTest
  Scenario Outline: User enters valid card payment details
    ...
    Examples: 
      ...
      | Test       | autoamtion  | Orikan    | 123 Main St    | 4th Road       | New NY         |    12345 | New York | New South Wales | Your Contact Details are saved successfully | Tester           | VISA      | 4111111111111111 |      123 | August       |        2025 |
